...
static const float16_t atan2_coefs_f16[ATAN2_NB_COEFS_F16] = { 0.f16, 1.f16, 0.f16, -0.367f16,
                                                               0.152f16 };
...
__STATIC_FORCEINLINE float16_t arm_atan_limited_f16(float16_t x) {
    ...
    for(i = 1; i < ATAN2_NB_COEFS_F16; i++) {
        res =
            (_Float16) x * (_Float16) res + (_Float16) atan2_coefs_f16[ATAN2_NB_COEFS_F16 - 1 - i];
    }
