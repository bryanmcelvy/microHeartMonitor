...
/**
  ...
  @par           Scaling and Overflow Behavior
                   ...
                   The 2.30 intermediate results are accumulated in a 64-bit accumulator in 34.30
  format. This approach provides 33 guard bits and there is no risk of overflow. The 34.30 result is
  then truncated to 34.15 format by discarding the low 15 bits and then saturated to 1.15 format.

  @remark
                   Refer to \ref arm_correlate_fast_q15() for a faster but less precise version of
  this function.
  @remark
                   Refer to \ref arm_correlate_opt_q15() for a faster implementation of this
...
void arm_correlate_q15(const q15_t * pSrcA, uint32_t srcALen, const q15_t * pSrcB, uint32_t srcBLen,
    ...
    q31_t x0, x1, x2, x3,
        c0; /* Temporary input variables for holding input and coefficient values */
