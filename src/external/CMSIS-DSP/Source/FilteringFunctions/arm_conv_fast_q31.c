...
/**
  ...
  to avoid overflows completely the input signals must be scaled down. Scale down the inputs by
  ...
  @remark
                   Refer to \ref arm_conv_q31() for a slower implementation of this function which
  uses 64-bit accumulation to provide higher precision.
 */
