...
/**
 ...
 max(srcALen, srcBLen) - 1.
  ...
  @par           Scaling and Overflow Behavior
                   ...
                   Both the inputs are represented in 1.7 format and multiplications yield a 2.14
 result. The 2.14 intermediate results are accumulated in a 32-bit accumulator in 18.14 format. This
 approach provides 17 guard bits and there is no risk of overflow as long as <code>max(srcALen,
 srcBLen)<131072</code>. The 18.14 result is then truncated to 18.7 format by discarding the low 7
 bits and saturated to 1.7 format.

 @remark
                   Refer to \ref arm_correlate_opt_q7() for a faster implementation of this
 function.
 */

#if defined(ARM_MATH_MVE_FLOAT16) && !defined(ARM_MATH_AUTOVECTORIZE) && defined(__CMSIS_GCC_H)
#pragma GCC warning                                                                                \
    "Scalar version of arm_correlate_q7 built. Helium version has build issues with gcc."
#endif
