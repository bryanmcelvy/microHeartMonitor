...
void arm_split_rfft_q15(q15_t * pSrc, uint32_t fftLen, const q15_t * pATable, const q15_t * pBTable,
...
#define MVE_CMPLX_MULT_FX_AxB_S16(A, B)                                                            \
    vqdmladhxq_s16(vqdmlsdhq_s16((__typeof(A)) vuninitializedq_s16(), A, B), A, B)
#define MVE_CMPLX_MULT_FX_AxConjB_S16(A, B)                                                        \
    vqdmladhq_s16(vqdmlsdhxq_s16((__typeof(A)) vuninitializedq_s16(), A, B), A, B)
...
void arm_split_rifft_q15(q15_t * pSrc, uint32_t fftLen, const q15_t * pATable,
    ...
    while(i > 0U) {
        ...
        /* pIn[2 * i] * pATable[2 * i] + pIn[2 * i + 1] * pATable[2 * i + 1] + pIn[2 * n - 2 * i] *
         * pBTable[2 * i] */
