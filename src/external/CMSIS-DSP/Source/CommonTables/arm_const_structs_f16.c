...
const arm_cfft_instance_f16 arm_cfft_sR_f16_len16 = { 16, twiddleCoefF16_16,
                                                      armBitRevIndexTable_fixed_16,
                                                      ARMBITREVINDEXTABLE_FIXED_16_TABLE_LENGTH };

const arm_cfft_instance_f16 arm_cfft_sR_f16_len32 = { 32, twiddleCoefF16_32,
                                                      armBitRevIndexTable_fixed_32,
                                                      ARMBITREVINDEXTABLE_FIXED_32_TABLE_LENGTH };

const arm_cfft_instance_f16 arm_cfft_sR_f16_len64 = { 64, twiddleCoefF16_64,
                                                      armBitRevIndexTable_fixed_64,
                                                      ARMBITREVINDEXTABLE_FIXED_64_TABLE_LENGTH };

const arm_cfft_instance_f16 arm_cfft_sR_f16_len128 = { 128, twiddleCoefF16_128,
                                                       armBitRevIndexTable_fixed_128,
                                                       ARMBITREVINDEXTABLE_FIXED_128_TABLE_LENGTH };

const arm_cfft_instance_f16 arm_cfft_sR_f16_len256 = { 256, twiddleCoefF16_256,
                                                       armBitRevIndexTable_fixed_256,
                                                       ARMBITREVINDEXTABLE_FIXED_256_TABLE_LENGTH };

const arm_cfft_instance_f16 arm_cfft_sR_f16_len512 = { 512, twiddleCoefF16_512,
