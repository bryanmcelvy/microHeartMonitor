...
const arm_cfft_instance_f64 arm_cfft_sR_f64_len16 = { 16, (const float64_t *) twiddleCoefF64_16,
                                                      armBitRevIndexTableF64_16,
                                                      ARMBITREVINDEXTABLEF64_16_TABLE_LENGTH };

const arm_cfft_instance_f64 arm_cfft_sR_f64_len32 = { 32, (const float64_t *) twiddleCoefF64_32,
                                                      armBitRevIndexTableF64_32,
                                                      ARMBITREVINDEXTABLEF64_32_TABLE_LENGTH };

const arm_cfft_instance_f64 arm_cfft_sR_f64_len64 = { 64, (const float64_t *) twiddleCoefF64_64,
                                                      armBitRevIndexTableF64_64,
                                                      ARMBITREVINDEXTABLEF64_64_TABLE_LENGTH };

const arm_cfft_instance_f64 arm_cfft_sR_f64_len128 = { 128, (const float64_t *) twiddleCoefF64_128,
                                                       armBitRevIndexTableF64_128,
                                                       ARMBITREVINDEXTABLEF64_128_TABLE_LENGTH };

const arm_cfft_instance_f64 arm_cfft_sR_f64_len256 = { 256, (const float64_t *) twiddleCoefF64_256,
                                                       armBitRevIndexTableF64_256,
                                                       ARMBITREVINDEXTABLEF64_256_TABLE_LENGTH };

const arm_cfft_instance_f64 arm_cfft_sR_f64_len512 = { 512, (const float64_t *) twiddleCoefF64_512,
                                                       armBitRevIndexTableF64_512,
                                                       ARMBITREVINDEXTABLEF64_512_TABLE_LENGTH };

const arm_cfft_instance_f64 arm_cfft_sR_f64_len1024 = { 1024,
                                                        (const float64_t *) twiddleCoefF64_1024,
                                                        armBitRevIndexTableF64_1024,
                                                        ARMBITREVINDEXTABLEF64_1024_TABLE_LENGTH };

const arm_cfft_instance_f64 arm_cfft_sR_f64_len2048 = { 2048,
                                                        (const float64_t *) twiddleCoefF64_2048,
                                                        armBitRevIndexTableF64_2048,
                                                        ARMBITREVINDEXTABLEF64_2048_TABLE_LENGTH };

const arm_cfft_instance_f64 arm_cfft_sR_f64_len4096 = { 4096,
                                                        (const float64_t *) twiddleCoefF64_4096,
...
const arm_rfft_fast_instance_f64 arm_rfft_fast_sR_f64_len32 = {
    { 16, (const float64_t *) twiddleCoefF64_16, armBitRevIndexTableF64_16,
      ARMBITREVINDEXTABLEF64_16_TABLE_LENGTH },
    32U,
...
const arm_rfft_fast_instance_f64 arm_rfft_fast_sR_f64_len64 = {
    { 32, (const float64_t *) twiddleCoefF64_32, armBitRevIndexTableF64_32,
      ARMBITREVINDEXTABLEF64_32_TABLE_LENGTH },
    64U,
...
const arm_rfft_fast_instance_f64 arm_rfft_fast_sR_f64_len256 = {
    { 128, (const float64_t *) twiddleCoefF64_128, armBitRevIndexTableF64_128,
      ARMBITREVINDEXTABLEF64_128_TABLE_LENGTH },
    256U,
...
const arm_rfft_fast_instance_f64 arm_rfft_fast_sR_f64_len512 = {
    { 256, (const float64_t *) twiddleCoefF64_256, armBitRevIndexTableF64_256,
      ARMBITREVINDEXTABLEF64_256_TABLE_LENGTH },
    512U,
...
const arm_rfft_fast_instance_f64 arm_rfft_fast_sR_f64_len1024 = {
    { 512, (const float64_t *) twiddleCoefF64_512, armBitRevIndexTableF64_512,
      ARMBITREVINDEXTABLEF64_512_TABLE_LENGTH },
    1024U,
...
const arm_rfft_fast_instance_f64 arm_rfft_fast_sR_f64_len2048 = {
    { 1024, (const float64_t *) twiddleCoefF64_1024, armBitRevIndexTableF64_1024,
      ARMBITREVINDEXTABLEF64_1024_TABLE_LENGTH },
    2048U,
...
const arm_rfft_fast_instance_f64 arm_rfft_fast_sR_f64_len4096 = {
    { 2048, (const float64_t *) twiddleCoefF64_2048, armBitRevIndexTableF64_2048,
      ARMBITREVINDEXTABLEF64_2048_TABLE_LENGTH },
    4096U,
