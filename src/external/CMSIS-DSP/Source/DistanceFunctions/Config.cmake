cmake_minimum_required(VERSION 3.14)
    ...
    target_sources(CMSISDSP PRIVATE DistanceFunctions / arm_boolean_distance.c) target_sources(
        CMSISDSP PRIVATE DistanceFunctions /
        arm_braycurtis_distance_f32
            .c) target_sources(CMSISDSP PRIVATE DistanceFunctions /
                                                      ...
                                                      arm_chebyshev_distance_f32
                                                          .c) target_sources(CMSISDSP PRIVATE
                                                                             ...
                                                                             arm_chebyshev_distance_f64
                                                                                 .c)
        target_sources(CMSISDSP PRIVATE DistanceFunctions /
                    ...
                    target_sources(
                        ...
                        target_sources(
                            ...
                            target_sources(CMSISDSP PRIVATE DistanceFunctions /
                                ...
                                target_sources(
                                    CMSISDSP PRIVATE DistanceFunctions /
                                    arm_yule_distance.c) target_sources(CMSISDSP PRIVATE
                                                                            DistanceFunctions /
                                                                        arm_dtw_distance_f32.c)
                                    target_sources(
                                        CMSISDSP PRIVATE DistanceFunctions /
                                        arm_dtw_path_f32.c) target_sources(CMSISDSP PRIVATE
                                                                               DistanceFunctions /
