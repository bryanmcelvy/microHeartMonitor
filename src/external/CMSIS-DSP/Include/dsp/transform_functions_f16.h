...
arm_status arm_mfcc_init_32_f16(arm_mfcc_instance_f16 * S, uint32_t nbMelFilters,
...
arm_status arm_mfcc_init_64_f16(arm_mfcc_instance_f16 * S, uint32_t nbMelFilters,
                                uint32_t nbDctOutputs, const float16_t * dctCoefs,
                                const uint32_t * filterPos, const uint32_t * filterLengths,
                                const float16_t * filterCoefs, const float16_t * windowCoefs);

arm_status arm_mfcc_init_128_f16(arm_mfcc_instance_f16 * S, uint32_t nbMelFilters,
                                 uint32_t nbDctOutputs, const float16_t * dctCoefs,
                                 const uint32_t * filterPos, const uint32_t * filterLengths,
                                 const float16_t * filterCoefs, const float16_t * windowCoefs);

arm_status arm_mfcc_init_256_f16(arm_mfcc_instance_f16 * S, uint32_t nbMelFilters,
                                 uint32_t nbDctOutputs, const float16_t * dctCoefs,
                                 const uint32_t * filterPos, const uint32_t * filterLengths,
                                 const float16_t * filterCoefs, const float16_t * windowCoefs);

arm_status arm_mfcc_init_512_f16(arm_mfcc_instance_f16 * S, uint32_t nbMelFilters,
                                 uint32_t nbDctOutputs, const float16_t * dctCoefs,
                                 const uint32_t * filterPos, const uint32_t * filterLengths,
                                 const float16_t * filterCoefs, const float16_t * windowCoefs);

arm_status arm_mfcc_init_1024_f16(arm_mfcc_instance_f16 * S, uint32_t nbMelFilters,
                                  uint32_t nbDctOutputs, const float16_t * dctCoefs,
                                  const uint32_t * filterPos, const uint32_t * filterLengths,
                                  const float16_t * filterCoefs, const float16_t * windowCoefs);

arm_status arm_mfcc_init_2048_f16(arm_mfcc_instance_f16 * S, uint32_t nbMelFilters,
                                  uint32_t nbDctOutputs, const float16_t * dctCoefs,
                                  const uint32_t * filterPos, const uint32_t * filterLengths,
                                  const float16_t * filterCoefs, const float16_t * windowCoefs);

arm_status arm_mfcc_init_4096_f16(arm_mfcc_instance_f16 * S, uint32_t nbMelFilters,
                                  uint32_t nbDctOutputs, const float16_t * dctCoefs,
                                  const uint32_t * filterPos, const uint32_t * filterLengths,
                                  const float16_t * filterCoefs, const float16_t * windowCoefs);
