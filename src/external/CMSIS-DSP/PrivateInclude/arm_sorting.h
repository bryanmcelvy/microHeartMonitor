 ...
 */
void arm_bubble_sort_f32(const arm_sort_instance_f32 * S, float32_t * pSrc, float32_t * pDst,
                         uint32_t blockSize);
 ...
 * @param[in]  blockSize  number of samples to process.
 */
void arm_heap_sort_f32(const arm_sort_instance_f32 * S, float32_t * pSrc, float32_t * pDst,
                       uint32_t blockSize);
 ...
 * @param[in]  blockSize  number of samples to process.
 */
void arm_insertion_sort_f32(const arm_sort_instance_f32 * S, float32_t * pSrc, float32_t * pDst,
                            uint32_t blockSize);
 ...
 * @param[in]  blockSize  number of samples to process.
 */
void arm_quick_sort_f32(const arm_sort_instance_f32 * S, float32_t * pSrc, float32_t * pDst,
                        uint32_t blockSize);
 ...
 * @param[in]  blockSize  number of samples to process.
 */
void arm_bitonic_sort_f32(const arm_sort_instance_f32 * S, float32_t * pSrc, float32_t * pDst,
                          uint32_t blockSize);
...
#define vrev256q_f32(a)                                                                            \
    do {                                                                                           \
        float32x4_t rev_tmp =                                                                      \
            vcombine_f32(vrev64_f32(vget_high_f32(a.val[0])), vrev64_f32(vget_low_f32(a.val[0]))); \
        a.val[0] =                                                                                 \
            vcombine_f32(vrev64_f32(vget_high_f32(a.val[1])), vrev64_f32(vget_low_f32(a.val[1]))); \
        a.val[1] = rev_tmp;                                                                        \
    } while(0)
