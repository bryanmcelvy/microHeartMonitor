...
arm_status arm_cfft_init_f16(arm_cfft_instance_f16 * S, uint16_t fftLen) {
    ...
    case 256U: status = arm_cfft_init_256_f16(S); break;

    case 128U: status = arm_cfft_init_128_f16(S); break;

    case 64U: status = arm_cfft_init_64_f16(S); break;

    case 32U: status = arm_cfft_init_32_f16(S); break;
