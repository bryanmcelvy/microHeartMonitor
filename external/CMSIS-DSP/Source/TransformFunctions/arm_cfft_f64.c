 ...
 * Description:  Combined Radix Decimation in Frequency CFFT Double Precision Floating point
 * processing function
 *
 * $Date:        23 April 2021
 * $Revision:    V1.9.0
...
extern void arm_radix4_butterfly_f64(float64_t * pSrc, uint16_t fftLen, const float64_t * pCoef,
...
void arm_radix4_butterfly_f64(float64_t * pSrc, uint16_t fftLen, const float64_t * pCoef,
                              uint16_t twidCoefModifier) {
...
void arm_cfft_radix4by2_f64(float64_t * pSrc, uint32_t fftLen, const float64_t * pCoef) {
    uint32_t i, l;
    uint32_t n2, ia;
...
/**
  ...
  @param[in]     S              points to an instance of the Double Precision floating-point CFFT
  structure
