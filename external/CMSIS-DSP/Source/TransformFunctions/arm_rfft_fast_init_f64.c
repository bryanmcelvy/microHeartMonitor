 ...
 * Description:  Split Radix Decimation in Frequency CFFT Double Precision Floating point processing
 * function
 *
 * $Date:        23 April 2021
 * $Revision:    V1.9.0
...
/**
  ...
  @par
                   This Function also initializes Twiddle factor table pointer and Bit reversal
  table pointer.
...
arm_status arm_rfft_fast_init_f64(arm_rfft_fast_instance_f64 * S, uint16_t fftLen) {
    ...
    switch(fftLen) {
    case 4096U: status = arm_rfft_fast_init_4096_f64(S); break;
    case 2048U: status = arm_rfft_fast_init_2048_f64(S); break;
    case 1024U: status = arm_rfft_fast_init_1024_f64(S); break;
    case 512U: status = arm_rfft_fast_init_512_f64(S); break;
    case 256U: status = arm_rfft_fast_init_256_f64(S); break;
    case 128U: status = arm_rfft_fast_init_128_f64(S); break;
    case 64U: status = arm_rfft_fast_init_64_f64(S); break;
    case 32U: status = arm_rfft_fast_init_32_f64(S); break;
