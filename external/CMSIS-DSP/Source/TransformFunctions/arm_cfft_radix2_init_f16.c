...
/**
  ...
  transform is computed. Set(=1) ifftFlag for calculation of CIFFT otherwise  CFFT is calculated
  @par
  ...
  @par
                   The parameter <code>fftLen</code> Specifies length of CFFT/CIFFT process.
