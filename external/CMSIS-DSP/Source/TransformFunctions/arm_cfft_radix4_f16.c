...
void arm_radix4_butterfly_f16(float16_t * pSrc, uint16_t fftLen, const float16_t * pCoef,
                              uint16_t twidCoefModifier);

void arm_radix4_butterfly_inverse_f16(float16_t * pSrc, uint16_t fftLen, const float16_t * pCoef,
...
void arm_cfft_radix4_f16(const arm_cfft_radix4_instance_f16 * S, float16_t * pSrc) {
    if(S->ifftFlag == 1U) {
        ...
        arm_radix4_butterfly_inverse_f16(pSrc, S->fftLen, S->pTwiddle, S->twidCoefModifier,
                                         S->onebyfftLen);
    }
    else {
        /*  Complex FFT radix-4  */
