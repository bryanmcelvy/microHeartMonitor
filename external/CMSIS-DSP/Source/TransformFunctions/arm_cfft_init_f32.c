...
arm_status arm_cfft_init_f32(arm_cfft_instance_f32 * S, uint16_t fftLen) {
    ...
    case 256U: status = arm_cfft_init_256_f32(S); break;

    case 128U: status = arm_cfft_init_128_f32(S); break;

    case 64U: status = arm_cfft_init_64_f32(S); break;

    case 32U: status = arm_cfft_init_32_f32(S); break;
