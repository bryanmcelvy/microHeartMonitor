...
extern void arm_radix4_butterfly_f32(float32_t * pSrc, uint16_t fftLen, const float32_t * pCoef,
...
void arm_split_rfft_f32(float32_t * pSrc, uint32_t fftLen, const float32_t * pATable,
                        const float32_t * pBTable, float32_t * pDst, uint32_t modifier);

void arm_split_rifft_f32(float32_t * pSrc, uint32_t fftLen, const float32_t * pATable,
                         const float32_t * pBTable, float32_t * pDst, uint32_t modifier);
...
/**
  ...
  @deprecated    Do not use this function.  It has been superceded by \ref arm_rfft_fast_f32 and
