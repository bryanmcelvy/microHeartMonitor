...
/**
  ...
  filter. <code>pState</code> points to the array of state variables and size of array is
                   <code>numTaps+blockSize-1</code> samples, where <code>blockSize</code> is the
  number of input samples processed by each call to <code>arm_lms_norm_q15()</code>.
 */
