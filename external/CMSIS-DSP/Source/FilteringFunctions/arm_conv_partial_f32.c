...
/**
  ...
  firstIndex+numPoints-1]</code>. The output array <code>pDst</code> contains <code>numPoints</code>
  values.
  ...
  @par           Fast Versions
                   ...
                   Cycles for Fast versions are less compared to Q31 and Q15 of partial conv and the
  design requires the input signals should be scaled down to avoid intermediate overflows.
  ...
  (Scratch memory) compared to Q15 and Q7 versions of partial convolution
...
/**
  ...
  @return        execution status
                   ...
                   - \ref ARM_MATH_ARGUMENT_ERROR : requested subset is not in the range [0
  srcALen+srcBLen-2]
 */
...
arm_status arm_conv_partial_f32(const float32_t * pSrcA, uint32_t srcALen, const float32_t * pSrcB,
    ...
    if((firstIndex + numPoints) > ((srcALen + (srcBLen - 1U)))) {
        ...
        blockSize3 =
            ((int32_t) check > (int32_t) srcALen) ? (int32_t) check - (int32_t) srcALen : 0;
