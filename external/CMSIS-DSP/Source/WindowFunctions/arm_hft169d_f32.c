...
void arm_hft169d_f32(float32_t * pDst, uint32_t blockSize) {
    ...
    for(uint32_t i = 0; i < blockSize; i++) {
        w = PI * (i * k);
        w = (1.0f - 1.97441843f * cosf(w) + 1.65409889f * cosf(2.f * w) -
             0.95788187f * cosf(3.f * w) + 0.33673420f * cosf(4.f * w) -
             0.06364622f * cosf(5.f * w) + 0.00521942f * cosf(6.f * w) -
             0.00010599f * cosf(7.f * w));
