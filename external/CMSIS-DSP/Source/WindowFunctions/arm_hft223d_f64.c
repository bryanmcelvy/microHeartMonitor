...
void arm_hft223d_f64(float64_t * pDst, uint32_t blockSize) {
    ...
    for(uint32_t i = 0; i < blockSize; i++) {
        w = PI_F64 * (i * k);
        w = (1.0 - 1.98298997309 * cos(w) + 1.75556083063 * cos(2. * w) -
             1.19037717712 * cos(3. * w) + 0.56155440797 * cos(4. * w) -
             0.17296769663 * cos(5. * w) + 0.03233247087 * cos(6. * w) -
             0.00324954578 * cos(7. * w) + 0.00013801040 * cos(8. * w) -
             0.00000132725 * cos(9. * w));
