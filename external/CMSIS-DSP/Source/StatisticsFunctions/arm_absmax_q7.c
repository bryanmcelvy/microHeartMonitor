...
#pragma GCC warning                                                                                \
    "Scalar version of arm_absmax_q7 built. Helium version has build issues with gcc."
#endif
...
static void arm_small_blk_absmax_q7(const q7_t * pSrc, uint16_t blockSize, q7_t * pResult,
                                    uint32_t * pIndex) {
