...
/**
  ...
  @par           Scaling and Overflow Behavior
                   ...
                   The Q7 value -1 (0x80) will be saturated to the maximum allowable positive value
  0x7F.
 */
...
void arm_abs_q7(const q7_t * pSrc, q7_t * pDst, uint32_t blockSize) {
    ...
    while(blkCnt > 0U) {
        ...
        /* Calculate absolute of input (if -1 then saturated to 0x7f) and store result in
         * destination buffer. */
        in = *pSrc++;
