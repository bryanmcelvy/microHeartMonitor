 ...
 * =
 * \begin{pmatrix}
 *  a_{1,1} b_{1,1}+a_{1,2} b_{2,1}+a_{1,3} b_{3,1} & a_{1,1} b_{1,2}+a_{1,2} b_{2,2}+a_{1,3}
 b_{3,2} & a_{1,1} b_{1,3}+a_{1,2} b_{2,3}+a_{1,3} b_{3,3} \\
 *  a_{2,1} b_{1,1}+a_{2,2} b_{2,1}+a_{2,3} b_{3,1} & a_{2,1} b_{1,2}+a_{2,2} b_{2,2}+a_{2,3}
 b_{3,2} & a_{2,1} b_{1,3}+a_{2,2} b_{2,3}+a_{2,3} b_{3,3} \\
 *  a_{3,1} b_{1,1}+a_{3,2} b_{2,1}+a_{3,3} b_{3,1} & a_{3,1} b_{1,2}+a_{3,2} b_{2,2}+a_{3,3}
 b_{3,2} & a_{3,1} b_{1,3}+a_{3,2} b_{2,3}+a_{3,3} b_{3,3} \\
 * \end{pmatrix}
 * \f]
...
__STATIC_INLINE arm_status arm_mat_mult_f32_2x2_mve(const arm_matrix_instance_f32 * pSrcA,
 ...
 */
__STATIC_INLINE arm_status arm_mat_mult_f32_3x3_mve(const arm_matrix_instance_f32 * pSrcA,
                                                    const arm_matrix_instance_f32 * pSrcB,
                                                    arm_matrix_instance_f32 * pDst) {
...
__STATIC_INLINE arm_status arm_mat_mult_f32_4x4_mve(const arm_matrix_instance_f32 * pSrcA,
                                                    const arm_matrix_instance_f32 * pSrcB,
                                                    arm_matrix_instance_f32 * pDst) {
    float32_t const * pSrBVec;
    float32_t * pInB = pSrcB->pData; /* input data matrix pointer B */
        ...
        */
        ...
        while(rowCnt > 0) {
            ...
            do {
                ...
                while(colCnt > 0U) {
                    /* c(m,n) = a(1,1)*b(1,1) + a(1,2)*b(2,1) + ... + a(m,p)*b(p,n) */
                    a0V = vld1q_f32(pIn1);               // load & separate real/imag pSrcA
                                                         // (de-interleave 2)
                    pIn1 += 4;
