...
arm_status arm_mat_qr_f16(const arm_matrix_instance_f16 * pSrc, const float16_t threshold,
                          arm_matrix_instance_f16 * pOutR, arm_matrix_instance_f16 * pOutQ,
                          float16_t * pOutTau, float16_t * pTmpA, float16_t * pTmpB);
...
float16_t arm_householder_f16(const float16_t * pSrc, const float16_t threshold, uint32_t blockSize,
                              float16_t * pOut);
