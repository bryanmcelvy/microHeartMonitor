...
#define EWIC_ISA_BASE                                                                              \
    (0xE001E400UL) /*!< External Wakeup Interrupt Controller interrupt status access Base Address  \
                    */
...
#define ARMCM55_PMU_CDE_PRED                                                                       \
    0xC416 /*!< Cycles where one or more predicated beats of a CDE instruction architecturally     \
              executed. */
...
#define ARMCM55_PMU_CDE_STALL_CUSTOM                                                               \
    0xC41A /*!< Stall cycles caused by a CDE instruction are generated by the custom hardware. */
#define ARMCM55_PMU_CDE_STALL_OTHER                                                                \
    0xC41B /*!< Stall cycles caused by a CDE instruction are not covered by the other counters. */
#define ARMCM55_PMU_PF_LF_LA_1                                                                     \
    0xC41C /*!< A data prefetcher line-fill request is made while the lookahead distance is 1. */
#define ARMCM55_PMU_PF_LF_LA_2                                                                     \
    0xC41D /*!< A data prefetcher line-fill request is made while the lookahead distance is 2. */
#define ARMCM55_PMU_PF_LF_LA_3                                                                     \
    0xC41E /*!< A data prefetcher line-fill request is made while the lookahead distance is 3. */
#define ARMCM55_PMU_PF_LF_LA_4                                                                     \
    0xC41F /*!< A data prefetcher line-fill request is made while the lookahead distance is 4. */
#define ARMCM55_PMU_PF_LF_LA_5                                                                     \
    0xC420 /*!< A data prefetcher line-fill request is made while the lookahead distance is 5. */
#define ARMCM55_PMU_PF_LF_LA_6                                                                     \
    0xC421 /*!< A data prefetcher line-fill request is made while the lookahead distance is 6. */
...
#define ARMCM55_PMU_PF_BUFFER_MISS                                                                 \
    0xC423 /*!< A load requires a line-fill which misses in the data prefetcher buffer. */
