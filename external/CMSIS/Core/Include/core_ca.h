...
#define GICDistributor                                                                             \
    ((GICDistributor_Type *)                                                                       \
         GIC_DISTRIBUTOR_BASE)   /*!< \brief GIC Distributor register set access pointer */

/* GICDistributor CTLR Register */
#define GICDistributor_CTLR_EnableGrp0_Pos 0U /*!< GICDistributor CTLR: EnableGrp0 Position */
#define GICDistributor_CTLR_EnableGrp0_Msk                                                         \
    (0x1U /*<< GICDistributor_CTLR_EnableGrp0_Pos*/) /*!< GICDistributor CTLR: EnableGrp0 Mask */
#define GICDistributor_CTLR_EnableGrp0(x)                                                          \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_CTLR_EnableGrp0_Pos*/)) &                   \
     GICDistributor_CTLR_EnableGrp0_Msk)

#define GICDistributor_CTLR_EnableGrp1_Pos 1U    /*!< GICDistributor CTLR: EnableGrp1 Position */
#define GICDistributor_CTLR_EnableGrp1_Msk                                                         \
    (0x1U << GICDistributor_CTLR_EnableGrp1_Pos) /*!< GICDistributor CTLR: EnableGrp1 Mask */
#define GICDistributor_CTLR_EnableGrp1(x)                                                          \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_CTLR_EnableGrp1_Pos)) &                       \
     GICDistributor_CTLR_EnableGrp1_Msk)

#define GICDistributor_CTLR_ARE_Pos 4U           /*!< GICDistributor CTLR: ARE Position */
#define GICDistributor_CTLR_ARE_Msk                                                                \
    (0x1U << GICDistributor_CTLR_ARE_Pos)        /*!< GICDistributor CTLR: ARE Mask */
#define GICDistributor_CTLR_ARE(x)                                                                 \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_CTLR_ARE_Pos)) & GICDistributor_CTLR_ARE_Msk)

#define GICDistributor_CTLR_DC_Pos 6U            /*!< GICDistributor CTLR: DC Position */
#define GICDistributor_CTLR_DC_Msk                                                                 \
    (0x1U << GICDistributor_CTLR_DC_Pos)         /*!< GICDistributor CTLR: DC Mask */
#define GICDistributor_CTLR_DC(x)                                                                  \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_CTLR_DC_Pos)) & GICDistributor_CTLR_DC_Msk)

#define GICDistributor_CTLR_EINWF_Pos 7U         /*!< GICDistributor CTLR: EINWF Position */
#define GICDistributor_CTLR_EINWF_Msk                                                              \
    (0x1U << GICDistributor_CTLR_EINWF_Pos)      /*!< GICDistributor CTLR: EINWF Mask */
#define GICDistributor_CTLR_EINWF(x)                                                               \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_CTLR_EINWF_Pos)) &                            \
     GICDistributor_CTLR_EINWF_Msk)

#define GICDistributor_CTLR_RWP_Pos 31U          /*!< GICDistributor CTLR: RWP Position */
#define GICDistributor_CTLR_RWP_Msk                                                                \
    (0x1U << GICDistributor_CTLR_RWP_Pos)        /*!< GICDistributor CTLR: RWP Mask */
#define GICDistributor_CTLR_RWP(x)                                                                 \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_CTLR_RWP_Pos)) & GICDistributor_CTLR_RWP_Msk)

/* GICDistributor TYPER Register */
#define GICDistributor_TYPER_ITLinesNumber_Pos                                                     \
    0U /*!< GICDistributor TYPER: ITLinesNumber Position */
#define GICDistributor_TYPER_ITLinesNumber_Msk                                                     \
    (0x1FU /*<< GICDistributor_TYPER_ITLinesNumber_Pos*/) /*!< GICDistributor TYPER: ITLinesNumber \
                                                             Mask */
#define GICDistributor_TYPER_ITLinesNumber(x)                                                      \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_TYPER_ITLinesNumber_Pos*/)) &               \
     GICDistributor_CTLR_ITLinesNumber_Msk)

#define GICDistributor_TYPER_CPUNumber_Pos 5U    /*!< GICDistributor TYPER: CPUNumber Position */
#define GICDistributor_TYPER_CPUNumber_Msk                                                         \
    (0x7U << GICDistributor_TYPER_CPUNumber_Pos) /*!< GICDistributor TYPER: CPUNumber Mask */
#define GICDistributor_TYPER_CPUNumber(x)                                                          \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_TYPER_CPUNumber_Pos)) &                       \
     GICDistributor_TYPER_CPUNumber_Msk)

#define GICDistributor_TYPER_SecurityExtn_Pos                                                      \
    10U                                          /*!< GICDistributor TYPER: SecurityExtn Position */
...
#define GICDistributor_TYPER_SecurityExtn(x)                                                       \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_TYPER_SecurityExtn_Pos)) &                    \
     GICDistributor_TYPER_SecurityExtn_Msk)

#define GICDistributor_TYPER_LSPI_Pos 11U           /*!< GICDistributor TYPER: LSPI Position */
#define GICDistributor_TYPER_LSPI_Msk                                                              \
    (0x1FU << GICDistributor_TYPER_LSPI_Pos)        /*!< GICDistributor TYPER: LSPI Mask */
#define GICDistributor_TYPER_LSPI(x)                                                               \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_TYPER_LSPI_Pos)) &                            \
...
#define GICDistributor_IIDR_Implementer(x)                                                         \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_IIDR_Implementer_Pos*/)) &                  \
     GICDistributor_IIDR_Implementer_Msk)

#define GICDistributor_IIDR_Revision_Pos 12U     /*!< GICDistributor IIDR: Revision Position */
#define GICDistributor_IIDR_Revision_Msk                                                           \
    (0xFU << GICDistributor_IIDR_Revision_Pos)   /*!< GICDistributor IIDR: Revision Mask */
#define GICDistributor_IIDR_Revision(x)                                                            \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_IIDR_Revision_Pos)) &                         \
     GICDistributor_IIDR_Revision_Msk)

#define GICDistributor_IIDR_Variant_Pos 16U      /*!< GICDistributor IIDR: Variant Position */
#define GICDistributor_IIDR_Variant_Msk                                                            \
    (0xFU << GICDistributor_IIDR_Variant_Pos)    /*!< GICDistributor IIDR: Variant Mask */
#define GICDistributor_IIDR_Variant(x)                                                             \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_IIDR_Variant_Pos)) &                          \
     GICDistributor_IIDR_Variant_Msk)

#define GICDistributor_IIDR_ProductID_Pos 24U    /*!< GICDistributor IIDR: ProductID Position */
#define GICDistributor_IIDR_ProductID_Msk                                                          \
    (0xFFU << GICDistributor_IIDR_ProductID_Pos) /*!< GICDistributor IIDR: ProductID Mask */
#define GICDistributor_IIDR_ProductID(x)                                                           \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_IIDR_ProductID_Pos)) &                        \
...
#define GICDistributor_STATUSR_RRD_Msk                                                             \
    (0x1U /*<< GICDistributor_STATUSR_RRD_Pos*/) /*!< GICDistributor STATUSR: RRD Mask */
#define GICDistributor_STATUSR_RRD(x)                                                              \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_STATUSR_RRD_Pos*/)) &                       \
     GICDistributor_STATUSR_RRD_Msk)

#define GICDistributor_STATUSR_WRD_Pos 1U        /*!< GICDistributor STATUSR: WRD Position */
#define GICDistributor_STATUSR_WRD_Msk                                                             \
    (0x1U << GICDistributor_STATUSR_WRD_Pos)     /*!< GICDistributor STATUSR: WRD Mask */
#define GICDistributor_STATUSR_WRD(x)                                                              \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_STATUSR_WRD_Pos)) &                           \
     GICDistributor_STATUSR_WRD_Msk)

#define GICDistributor_STATUSR_RWOD_Pos 2U       /*!< GICDistributor STATUSR: RWOD Position */
#define GICDistributor_STATUSR_RWOD_Msk                                                            \
    (0x1U << GICDistributor_STATUSR_RWOD_Pos)    /*!< GICDistributor STATUSR: RWOD Mask */
#define GICDistributor_STATUSR_RWOD(x)                                                             \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_STATUSR_RWOD_Pos)) &                          \
     GICDistributor_STATUSR_RWOD_Msk)

#define GICDistributor_STATUSR_WROD_Pos 3U       /*!< GICDistributor STATUSR: WROD Position */
#define GICDistributor_STATUSR_WROD_Msk                                                            \
    (0x1U << GICDistributor_STATUSR_WROD_Pos)    /*!< GICDistributor STATUSR: WROD Mask */
#define GICDistributor_STATUSR_WROD(x)                                                             \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_STATUSR_WROD_Pos)) &                          \
...
#define GICDistributor_SETSPI_NSR_INTID(x)                                                         \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_SETSPI_NSR_INTID_Pos*/)) &                  \
...
#define GICDistributor_CLRSPI_NSR_INTID(x)                                                         \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_CLRSPI_NSR_INTID_Pos*/)) &                  \
...
#define GICDistributor_SETSPI_SR_INTID_Msk                                                         \
    (0x3FFU /*<< GICDistributor_SETSPI_SR_INTID_Pos*/) /*!< GICDistributor SETSPI_SR: INTID Mask   \
                                                        */
#define GICDistributor_SETSPI_SR_INTID(x)                                                          \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_SETSPI_SR_INTID_Pos*/)) &                   \
...
#define GICDistributor_CLRSPI_SR_INTID_Msk                                                         \
    (0x3FFU /*<< GICDistributor_CLRSPI_SR_INTID_Pos*/) /*!< GICDistributor CLRSPI_SR: INTID Mask   \
                                                        */
#define GICDistributor_CLRSPI_SR_INTID(x)                                                          \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_CLRSPI_SR_INTID_Pos*/)) &                   \
...
#define GICDistributor_ITARGETSR_CPU0_Msk                                                          \
    (0x1U /*<< GICDistributor_ITARGETSR_CPU0_Pos*/) /*!< GICDistributor ITARGETSR: CPU0 Mask */
#define GICDistributor_ITARGETSR_CPU0(x)                                                           \
    (((uint8_t) (((uint8_t) (x)) /*<< GICDistributor_ITARGETSR_CPU0_Pos*/)) &                      \
     GICDistributor_ITARGETSR_CPU0_Msk)

#define GICDistributor_ITARGETSR_CPU1_Pos 1U        /*!< GICDistributor ITARGETSR: CPU1 Position */
#define GICDistributor_ITARGETSR_CPU1_Msk                                                          \
    (0x1U << GICDistributor_ITARGETSR_CPU1_Pos)     /*!< GICDistributor ITARGETSR: CPU1 Mask */
#define GICDistributor_ITARGETSR_CPU1(x)                                                           \
    (((uint8_t) (((uint8_t) (x)) << GICDistributor_ITARGETSR_CPU1_Pos)) &                          \
     GICDistributor_ITARGETSR_CPU1_Msk)

#define GICDistributor_ITARGETSR_CPU2_Pos 2U        /*!< GICDistributor ITARGETSR: CPU2 Position */
#define GICDistributor_ITARGETSR_CPU2_Msk                                                          \
    (0x1U << GICDistributor_ITARGETSR_CPU2_Pos)     /*!< GICDistributor ITARGETSR: CPU2 Mask */
#define GICDistributor_ITARGETSR_CPU2(x)                                                           \
    (((uint8_t) (((uint8_t) (x)) << GICDistributor_ITARGETSR_CPU2_Pos)) &                          \
...
#define GICDistributor_ITARGETSR_CPU3_Msk                                                          \
    (0x1U << GICDistributor_ITARGETSR_CPU3_Pos)     /*!< GICDistributor ITARGETSR: CPU3 Mask */
#define GICDistributor_ITARGETSR_CPU3(x)                                                           \
    (((uint8_t) (((uint8_t) (x)) << GICDistributor_ITARGETSR_CPU3_Pos)) &                          \
     GICDistributor_ITARGETSR_CPU3_Msk)

#define GICDistributor_ITARGETSR_CPU4_Pos 4U        /*!< GICDistributor ITARGETSR: CPU4 Position */
#define GICDistributor_ITARGETSR_CPU4_Msk                                                          \
    (0x1U << GICDistributor_ITARGETSR_CPU4_Pos)     /*!< GICDistributor ITARGETSR: CPU4 Mask */
#define GICDistributor_ITARGETSR_CPU4(x)                                                           \
    (((uint8_t) (((uint8_t) (x)) << GICDistributor_ITARGETSR_CPU4_Pos)) &                          \
     GICDistributor_ITARGETSR_CPU4_Msk)

#define GICDistributor_ITARGETSR_CPU5_Pos 5U        /*!< GICDistributor ITARGETSR: CPU5 Position */
#define GICDistributor_ITARGETSR_CPU5_Msk                                                          \
    (0x1U << GICDistributor_ITARGETSR_CPU5_Pos)     /*!< GICDistributor ITARGETSR: CPU5 Mask */
#define GICDistributor_ITARGETSR_CPU5(x)                                                           \
    (((uint8_t) (((uint8_t) (x)) << GICDistributor_ITARGETSR_CPU5_Pos)) &                          \
     GICDistributor_ITARGETSR_CPU5_Msk)

#define GICDistributor_ITARGETSR_CPU6_Pos 6U        /*!< GICDistributor ITARGETSR: CPU6 Position */
#define GICDistributor_ITARGETSR_CPU6_Msk                                                          \
    (0x1U << GICDistributor_ITARGETSR_CPU6_Pos)     /*!< GICDistributor ITARGETSR: CPU6 Mask */
#define GICDistributor_ITARGETSR_CPU6(x)                                                           \
    (((uint8_t) (((uint8_t) (x)) << GICDistributor_ITARGETSR_CPU6_Pos)) &                          \
     GICDistributor_ITARGETSR_CPU6_Msk)

#define GICDistributor_ITARGETSR_CPU7_Pos 7U        /*!< GICDistributor ITARGETSR: CPU7 Position */
#define GICDistributor_ITARGETSR_CPU7_Msk                                                          \
    (0x1U << GICDistributor_ITARGETSR_CPU7_Pos)     /*!< GICDistributor ITARGETSR: CPU7 Mask */
#define GICDistributor_ITARGETSR_CPU7(x)                                                           \
    (((uint8_t) (((uint8_t) (x)) << GICDistributor_ITARGETSR_CPU7_Pos)) &                          \
...
#define GICDistributor_SGIR_INTID_Msk                                                              \
    (0x7U /*<< GICDistributor_SGIR_INTID_Pos*/) /*!< GICDistributor SGIR: INTID Mask */
#define GICDistributor_SGIR_INTID(x)                                                               \
    (((uint32_t) (((uint32_t) (x)) /*<< GICDistributor_SGIR_INTID_Pos*/)) &                        \
     GICDistributor_SGIR_INTID_Msk)

#define GICDistributor_SGIR_NSATT_Pos 15U       /*!< GICDistributor SGIR: NSATT Position */
#define GICDistributor_SGIR_NSATT_Msk                                                              \
    (0x1U << GICDistributor_SGIR_NSATT_Pos)     /*!< GICDistributor SGIR: NSATT Mask */
#define GICDistributor_SGIR_NSATT(x)                                                               \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_SGIR_NSATT_Pos)) &                            \
     GICDistributor_SGIR_NSATT_Msk)

#define GICDistributor_SGIR_CPUTargetList_Pos                                                      \
    16U                                         /*!< GICDistributor SGIR: CPUTargetList  Position */
#define GICDistributor_SGIR_CPUTargetList_Msk                                                      \
    (0xFFU                                                                                         \
     << GICDistributor_SGIR_CPUTargetList_Pos)  /*!< GICDistributor SGIR: CPUTargetList  Mask */
#define GICDistributor_SGIR_CPUTargetList(x)                                                       \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_SGIR_CPUTargetList_Pos)) &                    \
     GICDistributor_SGIR_CPUTargetList_Msk)

#define GICDistributor_SGIR_TargetFilterList_Pos                                                   \
    24U /*!< GICDistributor SGIR: TargetFilterList Position */
#define GICDistributor_SGIR_TargetFilterList_Msk                                                   \
    (0x3U << GICDistributor_SGIR_TargetFilterList_Pos) /*!< GICDistributor SGIR: TargetFilterList  \
                                                          Mask */
#define GICDistributor_SGIR_TargetFilterList(x)                                                    \
    (((uint32_t) (((uint32_t) (x)) << GICDistributor_SGIR_TargetFilterList_Pos)) &                 \
...
#define GICDistributor_IROUTER_Aff0_Msk                                                            \
    (0xFFUL /*<< GICDistributor_IROUTER_Aff0_Pos*/) /*!< GICDistributor IROUTER: Aff0 Mask */
#define GICDistributor_IROUTER_Aff0(x)                                                             \
    (((uint64_t) (((uint64_t) (x)) /*<< GICDistributor_IROUTER_Aff0_Pos*/)) &                      \
     GICDistributor_IROUTER_Aff0_Msk)

#define GICDistributor_IROUTER_Aff1_Pos 8UL         /*!< GICDistributor IROUTER: Aff1 Position */
#define GICDistributor_IROUTER_Aff1_Msk                                                            \
    (0xFFUL << GICDistributor_IROUTER_Aff1_Pos)     /*!< GICDistributor IROUTER: Aff1 Mask */
#define GICDistributor_IROUTER_Aff1(x)                                                             \
    (((uint64_t) (((uint64_t) (x)) << GICDistributor_IROUTER_Aff1_Pos)) &                          \
     GICDistributor_IROUTER_Aff1_Msk)

#define GICDistributor_IROUTER_Aff2_Pos 16UL        /*!< GICDistributor IROUTER: Aff2 Position */
#define GICDistributor_IROUTER_Aff2_Msk                                                            \
    (0xFFUL << GICDistributor_IROUTER_Aff2_Pos)     /*!< GICDistributor IROUTER: Aff2 Mask */
#define GICDistributor_IROUTER_Aff2(x)                                                             \
    (((uint64_t) (((uint64_t) (x)) << GICDistributor_IROUTER_Aff2_Pos)) &                          \
     GICDistributor_IROUTER_Aff2_Msk)

#define GICDistributor_IROUTER_IRM_Pos 31UL         /*!< GICDistributor IROUTER: IRM Position */
#define GICDistributor_IROUTER_IRM_Msk                                                             \
    (0xFFUL << GICDistributor_IROUTER_IRM_Pos)      /*!< GICDistributor IROUTER: IRM Mask */
#define GICDistributor_IROUTER_IRM(x)                                                              \
    (((uint64_t) (((uint64_t) (x)) << GICDistributor_IROUTER_IRM_Pos)) &                           \
     GICDistributor_IROUTER_IRM_Msk)

#define GICDistributor_IROUTER_Aff3_Pos 32UL        /*!< GICDistributor IROUTER: Aff3 Position */
#define GICDistributor_IROUTER_Aff3_Msk                                                            \
    (0xFFUL << GICDistributor_IROUTER_Aff3_Pos)     /*!< GICDistributor IROUTER: Aff3 Mask */
#define GICDistributor_IROUTER_Aff3(x)                                                             \
    (((uint64_t) (((uint64_t) (x)) << GICDistributor_IROUTER_Aff3_Pos)) &                          \
...
#define GICInterface_CTLR_Enable_Msk                                                               \
    (0x1U /*<< GICInterface_CTLR_Enable_Pos*/) /*!< PTIM CTLR: Enable Mask */
#define GICInterface_CTLR_Enable(x)                                                                \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_CTLR_Enable_Pos*/)) &                         \
     GICInterface_CTLR_Enable_Msk)

/* GICInterface PMR Register */
#define GICInterface_PMR_Priority_Pos 0U         /*!< PTIM PMR: Priority Position */
#define GICInterface_PMR_Priority_Msk                                                              \
    (0xFFU /*<< GICInterface_PMR_Priority_Pos*/) /*!< PTIM PMR: Priority Mask */
#define GICInterface_PMR_Priority(x)                                                               \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_PMR_Priority_Pos*/)) &                        \
...
#define GICInterface_BPR_Binary_Point_Msk                                                          \
    (0x7U /*<< GICInterface_BPR_Binary_Point_Pos*/) /*!< PTIM BPR: Binary_Point Mask */
#define GICInterface_BPR_Binary_Point(x)                                                           \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_BPR_Binary_Point_Pos*/)) &                    \
     GICInterface_BPR_Binary_Point_Msk)

/* GICInterface IAR Register */
#define GICInterface_IAR_INTID_Pos 0U             /*!< PTIM IAR: INTID Position */
#define GICInterface_IAR_INTID_Msk                                                                 \
    (0xFFFFFFU /*<< GICInterface_IAR_INTID_Pos*/) /*!< PTIM IAR: INTID Mask */
#define GICInterface_IAR_INTID(x)                                                                  \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_IAR_INTID_Pos*/)) & GICInterface_IAR_INTID_Msk)

/* GICInterface EOIR Register */
#define GICInterface_EOIR_INTID_Pos 0U             /*!< PTIM EOIR: INTID Position */
#define GICInterface_EOIR_INTID_Msk                                                                \
    (0xFFFFFFU /*<< GICInterface_EOIR_INTID_Pos*/) /*!< PTIM EOIR: INTID Mask */
#define GICInterface_EOIR_INTID(x)                                                                 \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_EOIR_INTID_Pos*/)) &                          \
     GICInterface_EOIR_INTID_Msk)

/* GICInterface RPR Register */
#define GICInterface_RPR_INTID_Pos 0U         /*!< PTIM RPR: INTID Position */
#define GICInterface_RPR_INTID_Msk                                                                 \
    (0xFFU /*<< GICInterface_RPR_INTID_Pos*/) /*!< PTIM RPR: INTID Mask */
#define GICInterface_RPR_INTID(x)                                                                  \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_RPR_INTID_Pos*/)) & GICInterface_RPR_INTID_Msk)

/* GICInterface HPPIR Register */
#define GICInterface_HPPIR_INTID_Pos 0U             /*!< PTIM HPPIR: INTID Position */
#define GICInterface_HPPIR_INTID_Msk                                                               \
    (0xFFFFFFU /*<< GICInterface_HPPIR_INTID_Pos*/) /*!< PTIM HPPIR: INTID Mask */
#define GICInterface_HPPIR_INTID(x)                                                                \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_HPPIR_INTID_Pos*/)) &                         \
...
#define GICInterface_ABPR_Binary_Point_Msk                                                         \
    (0x7U /*<< GICInterface_ABPR_Binary_Point_Pos*/) /*!< PTIM ABPR: Binary_Point Mask */
#define GICInterface_ABPR_Binary_Point(x)                                                          \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_ABPR_Binary_Point_Pos*/)) &                   \
...
#define GICInterface_AIAR_INTID_Msk                                                                \
    (0xFFFFFFU /*<< GICInterface_AIAR_INTID_Pos*/) /*!< PTIM AIAR: INTID Mask */
#define GICInterface_AIAR_INTID(x)                                                                 \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_AIAR_INTID_Pos*/)) &                          \
     GICInterface_AIAR_INTID_Msk)

/* GICInterface AEOIR Register */
#define GICInterface_AEOIR_INTID_Pos 0U             /*!< PTIM AEOIR: INTID Position */
#define GICInterface_AEOIR_INTID_Msk                                                               \
    (0xFFFFFFU /*<< GICInterface_AEOIR_INTID_Pos*/) /*!< PTIM AEOIR: INTID Mask */
#define GICInterface_AEOIR_INTID(x)                                                                \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_AEOIR_INTID_Pos*/)) &                         \
...
#define GICInterface_AHPPIR_INTID_Msk                                                              \
    (0xFFFFFFU /*<< GICInterface_AHPPIR_INTID_Pos*/) /*!< PTIM AHPPIR: INTID Mask */
#define GICInterface_AHPPIR_INTID(x)                                                               \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_AHPPIR_INTID_Pos*/)) &                        \
...
#define GICInterface_STATUSR_RRD_Msk                                                               \
    (0x1U /*<< GICInterface_STATUSR_RRD_Pos*/) /*!< GICInterface STATUSR: RRD Mask */
#define GICInterface_STATUSR_RRD(x)                                                                \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_STATUSR_RRD_Pos*/)) &                         \
     GICInterface_STATUSR_RRD_Msk)

#define GICInterface_STATUSR_WRD_Pos 1U        /*!< GICInterface STATUSR: WRD Position */
#define GICInterface_STATUSR_WRD_Msk                                                               \
    (0x1U << GICInterface_STATUSR_WRD_Pos)     /*!< GICInterface STATUSR: WRD Mask */
#define GICInterface_STATUSR_WRD(x)                                                                \
    (((uint32_t) (((uint32_t) (x)) << GICInterface_STATUSR_WRD_Pos)) & GICInterface_STATUSR_WRD_Msk)

#define GICInterface_STATUSR_RWOD_Pos 2U       /*!< GICInterface STATUSR: RWOD Position */
#define GICInterface_STATUSR_RWOD_Msk                                                              \
    (0x1U << GICInterface_STATUSR_RWOD_Pos)    /*!< GICInterface STATUSR: RWOD Mask */
#define GICInterface_STATUSR_RWOD(x)                                                               \
    (((uint32_t) (((uint32_t) (x)) << GICInterface_STATUSR_RWOD_Pos)) &                            \
     GICInterface_STATUSR_RWOD_Msk)

#define GICInterface_STATUSR_WROD_Pos 3U       /*!< GICInterface STATUSR: WROD Position */
#define GICInterface_STATUSR_WROD_Msk                                                              \
    (0x1U << GICInterface_STATUSR_WROD_Pos)    /*!< GICInterface STATUSR: WROD Mask */
#define GICInterface_STATUSR_WROD(x)                                                               \
    (((uint32_t) (((uint32_t) (x)) << GICInterface_STATUSR_WROD_Pos)) &                            \
     GICInterface_STATUSR_WROD_Msk)

#define GICInterface_STATUSR_ASV_Pos 4U        /*!< GICInterface STATUSR: ASV Position */
#define GICInterface_STATUSR_ASV_Msk                                                               \
    (0x1U << GICInterface_STATUSR_ASV_Pos)     /*!< GICInterface STATUSR: ASV Mask */
#define GICInterface_STATUSR_ASV(x)                                                                \
    (((uint32_t) (((uint32_t) (x)) << GICInterface_STATUSR_ASV_Pos)) & GICInterface_STATUSR_ASV_Msk)

/* GICInterface IIDR Register */
#define GICInterface_IIDR_Implementer_Pos 0U /*!< GICInterface IIDR: Implementer Position */
#define GICInterface_IIDR_Implementer_Msk                                                          \
    (0xFFFU /*<< GICInterface_IIDR_Implementer_Pos*/) /*!< GICInterface IIDR: Implementer Mask */
#define GICInterface_IIDR_Implementer(x)                                                           \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_IIDR_Implementer_Pos*/)) &                    \
     GICInterface_IIDR_Implementer_Msk)

#define GICInterface_IIDR_Revision_Pos 12U            /*!< GICInterface IIDR: Revision Position */
#define GICInterface_IIDR_Revision_Msk                                                             \
    (0xFU << GICInterface_IIDR_Revision_Pos)          /*!< GICInterface IIDR: Revision Mask */
#define GICInterface_IIDR_Revision(x)                                                              \
    (((uint32_t) (((uint32_t) (x)) << GICInterface_IIDR_Revision_Pos)) &                           \
     GICInterface_IIDR_Revision_Msk)

#define GICInterface_IIDR_Arch_version_Pos 16U   /*!< GICInterface IIDR: Arch_version Position */
#define GICInterface_IIDR_Arch_version_Msk                                                         \
    (0xFU << GICInterface_IIDR_Arch_version_Pos) /*!< GICInterface IIDR: Arch_version Mask */
#define GICInterface_IIDR_Arch_version(x)                                                          \
    (((uint32_t) (((uint32_t) (x)) << GICInterface_IIDR_Arch_version_Pos)) &                       \
     GICInterface_IIDR_Arch_version_Msk)

#define GICInterface_IIDR_ProductID_Pos 20U      /*!< GICInterface IIDR: ProductID Position */
#define GICInterface_IIDR_ProductID_Msk                                                            \
    (0xFFFU << GICInterface_IIDR_ProductID_Pos)  /*!< GICInterface IIDR: ProductID Mask */
#define GICInterface_IIDR_ProductID(x)                                                             \
    (((uint32_t) (((uint32_t) (x)) << GICInterface_IIDR_ProductID_Pos)) &                          \
     GICInterface_IIDR_ProductID_Msk)

/* GICInterface DIR Register */
#define GICInterface_DIR_INTID_Pos 0U             /*!< PTIM DIR: INTID Position */
#define GICInterface_DIR_INTID_Msk                                                                 \
    (0xFFFFFFU /*<< GICInterface_DIR_INTID_Pos*/) /*!< PTIM DIR: INTID Mask */
#define GICInterface_DIR_INTID(x)                                                                  \
    (((uint32_t) (((uint32_t) (x)) /*<< GICInterface_DIR_INTID_Pos*/)) & GICInterface_DIR_INTID_Msk)
...
#define PTIM_CONTROL_Enable_Msk                                                                    \
    (0x1U /*<< PTIM_CONTROL_Enable_Pos*/) /*!< PTIM CONTROL: Enable Mask */
#define PTIM_CONTROL_Enable(x)                                                                     \
    (((uint32_t) (((uint32_t) (x)) /*<< PTIM_CONTROL_Enable_Pos*/)) & PTIM_CONTROL_Enable_Msk)

#define PTIM_CONTROL_AutoReload_Pos 1U    /*!< PTIM CONTROL: Auto Reload Position */
#define PTIM_CONTROL_AutoReload_Msk                                                                \
    (0x1U << PTIM_CONTROL_AutoReload_Pos) /*!< PTIM CONTROL: Auto Reload Mask */
#define PTIM_CONTROL_AutoReload(x)                                                                 \
    (((uint32_t) (((uint32_t) (x)) << PTIM_CONTROL_AutoReload_Pos)) & PTIM_CONTROL_AutoReload_Msk)

#define PTIM_CONTROL_IRQenable_Pos 2U     /*!< PTIM CONTROL: IRQ Enabel Position */
#define PTIM_CONTROL_IRQenable_Msk                                                                 \
    (0x1U << PTIM_CONTROL_IRQenable_Pos)  /*!< PTIM CONTROL: IRQ Enabel Mask */
#define PTIM_CONTROL_IRQenable(x)                                                                  \
    (((uint32_t) (((uint32_t) (x)) << PTIM_CONTROL_IRQenable_Pos)) & PTIM_CONTROL_IRQenable_Msk)

#define PTIM_CONTROL_Prescaler_Pos 8U     /*!< PTIM CONTROL: Prescaler Position */
#define PTIM_CONTROL_Prescaler_Msk                                                                 \
    (0xFFU << PTIM_CONTROL_Prescaler_Pos) /*!< PTIM CONTROL: Prescaler Mask */
#define PTIM_CONTROL_Prescaler(x)                                                                  \
    (((uint32_t) (((uint32_t) (x)) << PTIM_CONTROL_Prescaler_Pos)) & PTIM_CONTROL_Prescaler_Msk)

/* WCONTROL Watchdog Control Register */
#define PTIM_WCONTROL_Enable_Pos 0U        /*!< PTIM WCONTROL: Enable Position */
#define PTIM_WCONTROL_Enable_Msk                                                                   \
    (0x1U /*<< PTIM_WCONTROL_Enable_Pos*/) /*!< PTIM WCONTROL: Enable Mask */
#define PTIM_WCONTROL_Enable(x)                                                                    \
    (((uint32_t) (((uint32_t) (x)) /*<< PTIM_WCONTROL_Enable_Pos*/)) & PTIM_WCONTROL_Enable_Msk)

#define PTIM_WCONTROL_AutoReload_Pos 1U    /*!< PTIM WCONTROL: Auto Reload Position */
#define PTIM_WCONTROL_AutoReload_Msk                                                               \
    (0x1U << PTIM_WCONTROL_AutoReload_Pos) /*!< PTIM WCONTROL: Auto Reload Mask */
#define PTIM_WCONTROL_AutoReload(x)                                                                \
    (((uint32_t) (((uint32_t) (x)) << PTIM_WCONTROL_AutoReload_Pos)) & PTIM_WCONTROL_AutoReload_Msk)

#define PTIM_WCONTROL_IRQenable_Pos 2U     /*!< PTIM WCONTROL: IRQ Enable Position */
#define PTIM_WCONTROL_IRQenable_Msk                                                                \
    (0x1U << PTIM_WCONTROL_IRQenable_Pos)  /*!< PTIM WCONTROL: IRQ Enable Mask */
#define PTIM_WCONTROL_IRQenable(x)                                                                 \
    (((uint32_t) (((uint32_t) (x)) << PTIM_WCONTROL_IRQenable_Pos)) & PTIM_WCONTROL_IRQenable_Msk)

#define PTIM_WCONTROL_Mode_Pos 3U          /*!< PTIM WCONTROL: Watchdog Mode Position */
#define PTIM_WCONTROL_Mode_Msk                                                                     \
    (0x1U << PTIM_WCONTROL_Mode_Pos)       /*!< PTIM WCONTROL: Watchdog Mode Mask */
#define PTIM_WCONTROL_Mode(x)                                                                      \
    (((uint32_t) (((uint32_t) (x)) << PTIM_WCONTROL_Mode_Pos)) & PTIM_WCONTROL_Mode_Msk)

#define PTIM_WCONTROL_Presacler_Pos 8U     /*!< PTIM WCONTROL: Prescaler Position */
#define PTIM_WCONTROL_Presacler_Msk                                                                \
    (0xFFU << PTIM_WCONTROL_Presacler_Pos) /*!< PTIM WCONTROL: Prescaler Mask */
#define PTIM_WCONTROL_Presacler(x)                                                                 \
    (((uint32_t) (((uint32_t) (x)) << PTIM_WCONTROL_Presacler_Pos)) & PTIM_WCONTROL_Presacler_Msk)

/* WISR Watchdog Interrupt Status Register */
#define PTIM_WISR_EventFlag_Pos 0U        /*!< PTIM WISR: Event Flag Position */
#define PTIM_WISR_EventFlag_Msk                                                                    \
    (0x1U /*<< PTIM_WISR_EventFlag_Pos*/) /*!< PTIM WISR: Event Flag Mask */
#define PTIM_WISR_EventFlag(x)                                                                     \
    (((uint32_t) (((uint32_t) (x)) /*<< PTIM_WISR_EventFlag_Pos*/)) & PTIM_WISR_EventFlag_Msk)

/* WRESET Watchdog Reset Status */
#define PTIM_WRESET_ResetFlag_Pos 0U        /*!< PTIM WRESET: Reset Flag Position */
#define PTIM_WRESET_ResetFlag_Msk                                                                  \
    (0x1U /*<< PTIM_WRESET_ResetFlag_Pos*/) /*!< PTIM WRESET: Reset Flag Mask */
#define PTIM_WRESET_ResetFlag(x)                                                                   \
    (((uint32_t) (((uint32_t) (x)) /*<< PTIM_WRESET_ResetFlag_Pos*/)) & PTIM_WRESET_ResetFlag_Msk)
...
/** \brief  Set 4k/64k page access privileges
  ...
  \return          0
*/
__STATIC_INLINE int MMU_APPage(uint32_t * descriptor_l2, mmu_access_Type user, mmu_access_Type priv,
                               uint32_t afe) {
    uint32_t ap = 0;
...
/** \brief  Set Section memory attributes
  ...
  \return          0
*/
__STATIC_INLINE int MMU_MemorySection(uint32_t * descriptor_l1, mmu_memory_Type mem,
...
*/
__STATIC_INLINE void MMU_TTSection(uint32_t * ttb, uint32_t base_address, uint32_t count,
...
*/
__STATIC_INLINE void MMU_TTPage4k(uint32_t * ttb, uint32_t base_address, uint32_t count,
                                  uint32_t descriptor_l1, uint32_t * ttb_l2,
...
*/
__STATIC_INLINE void MMU_TTPage64k(uint32_t * ttb, uint32_t base_address, uint32_t count,
                                   uint32_t descriptor_l1, uint32_t * ttb_l2,
                                   uint32_t descriptor_l2) {
    uint32_t offset, offset2;
    uint32_t entry, entry2;
