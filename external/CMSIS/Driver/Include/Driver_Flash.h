...
typedef struct _ARM_FLASH_INFO {
    ARM_FLASH_SECTOR *
        sector_info;                     ///< Sector layout information (NULL=Uniform sectors)
...
typedef struct _ARM_DRIVER_FLASH {
    ...
    int32_t (*Initialize)(
        ARM_Flash_SignalEvent_t cb_event);               ///< Pointer to \ref ARM_Flash_Initialize :
                                                         ///< Initialize Flash Interface.
    int32_t (*Uninitialize)(void);               ///< Pointer to \ref ARM_Flash_Uninitialize :
                                                 ///< De-initialize Flash Interface.
    int32_t (*PowerControl)(
        ARM_POWER_STATE state);               ///< Pointer to \ref ARM_Flash_PowerControl : Control
                                              ///< Flash Interface Power.
    int32_t (*ReadData)(
    ...
    int32_t (*ProgramData)(uint32_t addr, const void * data,
                           uint32_t cnt);               ///< Pointer to \ref ARM_Flash_ProgramData :
                                                        ///< Program data to Flash.
    int32_t (*EraseSector)(uint32_t addr);               ///< Pointer to \ref ARM_Flash_EraseSector
                                                         ///< : Erase Flash Sector.
    int32_t (*EraseChip)(
