...
#define ARM_NAND_POWER_VCCQ_OFF                                                                    \
    (0x01UL << ARM_NAND_POWER_VCCQ_Pos)               ///< VCCQ I/O Power off
...
#define ARM_NAND_DRIVER_STRENGTH                                                                   \
    (0x03UL)               ///< Set Driver Strength as specified with arg
#define ARM_NAND_DEVICE_READY_EVENT                                                                \
    (0x04UL)               ///< Generate \ref ARM_NAND_EVENT_DEVICE_READY; arg: 0=disabled
                           ///< (default), 1=enabled
#define ARM_NAND_DRIVER_READY_EVENT                                                                \
    (0x05UL)               ///< Generate \ref ARM_NAND_EVENT_DRIVER_READY; arg: 0=disabled
                           ///< (default), 1=enabled
...
#define ARM_NAND_BUS_SDR                                                                           \
    (0x00UL                                                                                        \
     << ARM_NAND_BUS_INTERFACE_Pos)               ///< Data Interface:    SDR  (Single Data Rate) -
                                                  ///< Traditional interface (default)
#define ARM_NAND_BUS_DDR                                                                           \
    (0x01UL                                                                                        \
     << ARM_NAND_BUS_INTERFACE_Pos)               ///< Data Interface: NV-DDR  (Double Data Rate)
#define ARM_NAND_BUS_DDR2                                                                          \
    (0x02UL                                                                                        \
     << ARM_NAND_BUS_INTERFACE_Pos)               ///< Data Interface: NV-DDR2 (Double Data Rate)
#define ARM_NAND_BUS_TIMING_MODE_Pos 0
#define ARM_NAND_BUS_TIMING_MODE_Msk (0x0FUL << ARM_NAND_BUS_TIMING_MODE_Pos)
#define ARM_NAND_BUS_TIMING_MODE_0                                                                 \
    (0x00UL << ARM_NAND_BUS_TIMING_MODE_Pos)                ///< Timing Mode 0 (default)
#define ARM_NAND_BUS_TIMING_MODE_1                                                                 \
    (0x01UL << ARM_NAND_BUS_TIMING_MODE_Pos)                ///< Timing Mode 1
#define ARM_NAND_BUS_TIMING_MODE_2                                                                 \
    (0x02UL << ARM_NAND_BUS_TIMING_MODE_Pos)                ///< Timing Mode 2
#define ARM_NAND_BUS_TIMING_MODE_3                                                                 \
    (0x03UL << ARM_NAND_BUS_TIMING_MODE_Pos)                ///< Timing Mode 3
#define ARM_NAND_BUS_TIMING_MODE_4                                                                 \
    (0x04UL << ARM_NAND_BUS_TIMING_MODE_Pos)                ///< Timing Mode 4 (SDR EDO capable)
#define ARM_NAND_BUS_TIMING_MODE_5                                                                 \
    (0x05UL << ARM_NAND_BUS_TIMING_MODE_Pos)                ///< Timing Mode 5 (SDR EDO capable)
#define ARM_NAND_BUS_TIMING_MODE_6                                                                 \
    (0x06UL << ARM_NAND_BUS_TIMING_MODE_Pos)                ///< Timing Mode 6 (NV-DDR2 only)
#define ARM_NAND_BUS_TIMING_MODE_7                                                                 \
    (0x07UL << ARM_NAND_BUS_TIMING_MODE_Pos)                ///< Timing Mode 7 (NV-DDR2 only)
...
#define ARM_NAND_BUS_DDR2_DO_WCYC_0                                                                \
    (0x00UL << ARM_NAND_BUS_DDR2_DO_WCYC_Pos)               ///< DDR2 Data Output Warm-up cycles: 0
                                                            ///< (default)
#define ARM_NAND_BUS_DDR2_DO_WCYC_1                                                                \
    (0x01UL << ARM_NAND_BUS_DDR2_DO_WCYC_Pos)               ///< DDR2 Data Output Warm-up cycles: 1
#define ARM_NAND_BUS_DDR2_DO_WCYC_2                                                                \
    (0x02UL << ARM_NAND_BUS_DDR2_DO_WCYC_Pos)               ///< DDR2 Data Output Warm-up cycles: 2
#define ARM_NAND_BUS_DDR2_DO_WCYC_4                                                                \
    (0x03UL << ARM_NAND_BUS_DDR2_DO_WCYC_Pos)               ///< DDR2 Data Output Warm-up cycles: 4
...
#define ARM_NAND_BUS_DDR2_DI_WCYC_0                                                                \
    (0x00UL << ARM_NAND_BUS_DDR2_DI_WCYC_Pos)               ///< DDR2 Data Input Warm-up cycles: 0
                                                            ///< (default)
#define ARM_NAND_BUS_DDR2_DI_WCYC_1                                                                \
    (0x01UL << ARM_NAND_BUS_DDR2_DI_WCYC_Pos)               ///< DDR2 Data Input Warm-up cycles: 1
#define ARM_NAND_BUS_DDR2_DI_WCYC_2                                                                \
    (0x02UL << ARM_NAND_BUS_DDR2_DI_WCYC_Pos)               ///< DDR2 Data Input Warm-up cycles: 2
#define ARM_NAND_BUS_DDR2_DI_WCYC_4                                                                \
    (0x03UL << ARM_NAND_BUS_DDR2_DI_WCYC_Pos)               ///< DDR2 Data Input Warm-up cycles: 4
#define ARM_NAND_BUS_DDR2_VEN (1UL << 16)               ///< DDR2 Enable external VREFQ as reference
#define ARM_NAND_BUS_DDR2_CMPD                                                                     \
    (1UL << 17)               ///< DDR2 Enable complementary DQS (DQS_c) signal
#define ARM_NAND_BUS_DDR2_CMPR                                                                     \
    (1UL << 18)               ///< DDR2 Enable complementary RE_n (RE_c) signal
...
#define ARM_NAND_DRIVER_STRENGTH_35                                                                \
    (0x02UL)               ///< Driver Strength 1.0x = 35 Ohms (default)
...
#define ARM_NAND_DRIVER_DONE_EVENT                                                                 \
    (1UL << 16)               ///< Generate \ref ARM_NAND_EVENT_DRIVER_DONE
...
#define ARM_NAND_CODE_READ_STATUS                                                                  \
    (1UL << 29)               ///< Read Status byte and check FAIL bit (bit 0)
...
#define ARM_NAND_ERROR_ECC                                                                         \
    (ARM_DRIVER_ERROR_SPECIFIC - 1)               ///< ECC generation/correction failed

/**
\brief NAND ECC (Error Correction Code) Information
*/
typedef struct _ARM_NAND_ECC_INFO {
    uint32_t type : 2;               ///< Type: 1=ECC0 over Main, 2=ECC0 over Main+Spare, 3=ECC0
                                     ///< over Main and ECC1 over Spare
    uint32_t page_layout : 1;               ///< Page layout: 0=|Main0|Spare0|...|MainN-1|SpareN-1|,
                                            ///< 1=|Main0|...|MainN-1|Spare0|...|SpareN-1|
    uint32_t page_count : 3;                ///< Number of virtual pages: N = 2 ^ page_count
    uint32_t
        page_size : 4;                      ///< Virtual Page size (Main+Spare): 0=512+16, 1=1k+32,
                                     ///< 2=2k+64, 3=4k+128, 4=8k+256, 8=512+28, 9=1k+56, 10=2k+112,
                                     ///< 11=4k+224, 12=8k+448, 15=Not used (extended description)
    uint32_t reserved : 14;                      ///< Reserved (must be zero)
    uint32_t correctable_bits : 8;               ///< Number of correctable bits (based on 512 byte
                                                 ///< codeword size)
    ...
    uint16_t codeword_offset[2];                 ///< Codeword offset in bytes (where ECC protected
                                                 ///< data starts in Main/Spare)
...
typedef struct _ARM_NAND_STATUS {
    ...
    uint32_t ecc_error : 1;               ///< ECC error detected (cleared on next Read/WriteData or
                                          ///< ExecuteSequence)
...
*/
/**
  \fn            int32_t ARM_NAND_ReadData (uint32_t dev_num, void *data, uint32_t cnt, uint32_t
  mode) \brief         Read data from NAND device. \param[in]     dev_num  Device number \param[out]
  data     Pointer to buffer for data to read from NAND device \param[in]     cnt      Number of
  data items to read \param[in]     mode     Operation mode \return        number of data items read
  or \ref execution_status
*/
/**
  \fn            int32_t ARM_NAND_WriteData (uint32_t dev_num, const void *data, uint32_t cnt,
  uint32_t mode) \brief         Write data to NAND device. \param[in]     dev_num  Device number
...
typedef void (*ARM_NAND_SignalEvent_t)(
    uint32_t dev_num,
...
typedef struct _ARM_NAND_CAPABILITIES {
    ...
    uint32_t reentrant_operation : 1;               ///< Supports re-entrant operation
                                                    ///< (SendCommand/Address, Read/WriteData)
    uint32_t sequence_operation : 1;                ///< Supports Sequence operation
                                                    ///< (ExecuteSequence, AbortSequence)
    ...
    uint32_t sdr_timing_mode : 3;               ///< Fastest (highest) SDR     Timing Mode supported
                                                ///< (ONFI)
    uint32_t ddr_timing_mode : 3;               ///< Fastest (highest) NV_DDR  Timing Mode supported
                                                ///< (ONFI)
    uint32_t ddr2_timing_mode : 3;                 ///< Fastest (highest) NV_DDR2 Timing Mode
                                                   ///< supported (ONFI)
...
typedef struct _ARM_DRIVER_NAND {
    ...
    int32_t (*Initialize)(
        ARM_NAND_SignalEvent_t cb_event);               ///< Pointer to \ref ARM_NAND_Initialize :
                                                        ///< Initialize NAND Interface.
    int32_t (*Uninitialize)(void);                      ///< Pointer to \ref ARM_NAND_Uninitialize :
                                                        ///< De-initialize NAND Interface.
    int32_t (*PowerControl)(
        ARM_POWER_STATE state);               ///< Pointer to \ref ARM_NAND_PowerControl : Control
                                              ///< NAND Interface Power.
    int32_t (*DevicePower)(
        uint32_t voltage);                    ///< Pointer to \ref ARM_NAND_DevicePower : Set device
                                              ///< power supply voltage.
    int32_t (*WriteProtect)(uint32_t dev_num,
                            bool enable);               ///< Pointer to \ref ARM_NAND_WriteProtect :
                                                        ///< Control WPn (Write Protect).
    int32_t (*ChipEnable)(uint32_t dev_num,
                          bool enable);                 ///< Pointer to \ref ARM_NAND_ChipEnable :
                                                        ///< Control CEn (Chip Enable).
    int32_t (*GetDeviceBusy)(
        uint32_t dev_num);               ///< Pointer to \ref ARM_NAND_GetDeviceBusy : Get Device
                                         ///< Busy pin state.
    int32_t (*SendCommand)(uint32_t dev_num,
                           uint8_t cmd);                ///< Pointer to \ref ARM_NAND_SendCommand :
                                                        ///< Send command to NAND device.
    int32_t (*SendAddress)(uint32_t dev_num,
                           uint8_t addr);               ///< Pointer to \ref ARM_NAND_SendAddress :
                                                        ///< Send address to NAND device.
    int32_t (*ReadData)(uint32_t dev_num, void * data, uint32_t cnt,
                        uint32_t mode);                ///< Pointer to \ref ARM_NAND_ReadData : Read
                                                       ///< data from NAND device.
    int32_t (*WriteData)(uint32_t dev_num, const void * data, uint32_t cnt,
                         uint32_t mode);               ///< Pointer to \ref ARM_NAND_WriteData :
                                                       ///< Write data to NAND device.
    int32_t (*ExecuteSequence)(
        uint32_t dev_num, uint32_t code, uint32_t cmd, uint32_t addr_col, uint32_t addr_row,
        void * data, uint32_t data_cnt, uint8_t * status,
        uint32_t * count);               ///< Pointer to \ref ARM_NAND_ExecuteSequence : Execute
                                         ///< sequence of operations.
    int32_t (*AbortSequence)(
        uint32_t dev_num);               ///< Pointer to \ref ARM_NAND_AbortSequence : Abort
                                         ///< sequence execution.
    int32_t (*Control)(
        uint32_t dev_num, uint32_t control,
    ...
    int32_t (*InquireECC)(
        int32_t index,
        ARM_NAND_ECC_INFO * info);               ///< Pointer to \ref ARM_NAND_InquireECC : Inquire
                                                 ///< about available ECC.
