...
static const ARM_CAN_CAPABILITIES can_driver_capabilities = {
    ...
    0U,                // Does not support reentrant calls to ARM_CAN_MessageSend,
                      // ARM_CAN_MessageRead, ARM_CAN_ObjectConfigure and abort message sending used
                      // by ARM_CAN_Control.
...
static int32_t ARM_CAN_SetBitrate(ARM_CAN_BITRATE_SELECT select, uint32_t bitrate,
...
static int32_t ARM_CAN_ObjectSetFilter(uint32_t obj_idx, ARM_CAN_FILTER_OPERATION operation,
...
static int32_t ARM_CAN_MessageSend(uint32_t obj_idx, ARM_CAN_MSG_INFO * msg_info,
...
static int32_t ARM_CAN_MessageRead(uint32_t obj_idx, ARM_CAN_MSG_INFO * msg_info, uint8_t * data,
                                   uint8_t size) {
...
ARM_DRIVER_CAN Driver_CAN0 = {
    ARM_CAN_GetVersion,      ARM_CAN_GetCapabilities, ARM_CAN_Initialize,
    ARM_CAN_Uninitialize,    ARM_CAN_PowerControl,    ARM_CAN_GetClock,
    ARM_CAN_SetBitrate,      ARM_CAN_SetMode,         ARM_CAN_ObjectGetCapabilities,
    ARM_CAN_ObjectSetFilter, ARM_CAN_ObjectConfigure, ARM_CAN_MessageSend,
    ARM_CAN_MessageRead,     ARM_CAN_Control,         ARM_CAN_GetStatus
};
