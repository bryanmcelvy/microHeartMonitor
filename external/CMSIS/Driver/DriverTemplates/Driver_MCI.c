...
static int32_t ARM_MCI_SendCommand(uint32_t cmd, uint32_t arg, uint32_t flags,
                                   uint32_t * response) {}
...
ARM_DRIVER_MCI Driver_MCI0 = { ARM_MCI_GetVersion,    ARM_MCI_GetCapabilities, ARM_MCI_Initialize,
                               ARM_MCI_Uninitialize,  ARM_MCI_PowerControl,    ARM_MCI_CardPower,
                               ARM_MCI_ReadCD,        ARM_MCI_ReadWP,          ARM_MCI_SendCommand,
                               ARM_MCI_SetupTransfer, ARM_MCI_AbortTransfer,   ARM_MCI_Control,
                               ARM_MCI_GetStatus };
